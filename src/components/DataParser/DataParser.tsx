...
export const mapJsonToInputContribution = (json: never): InputContribution[] => {
  ...
  const getAssemblies = (assemblyDataArray: Record<string, never>[]): InputAssembly[] => {
    return assemblyDataArray.map((assemblyData) => {
      ...
      const products: InputProduct[] = [
        {
          ...
          type: 'actual',
          metaData: {
            product_class: assemblyData['meta_data.product_class'] || '',
            strength: assemblyData['meta_data.strength'] || 0,
            density: assemblyData['meta_data.density'] || 0,
            density_unit: assemblyData['meta_data.density_unit'] || '',
            exposure_classes: assemblyData['meta_data.exposure_classes'] || '',
            concrete_precast: assemblyData['meta_data.concrete_precast'] || '',
            brick_type: assemblyData['meta_data.brick_type'] || '',
            brick_grout_included: assemblyData['meta_data.brick_grout_included'] || '',
            timber_type: assemblyData['meta_data.timber_type'] || '',
            grout_type: assemblyData['meta_data.grout_type'] || '',
          },
        },
      ]
      ...
      return {
        ...
        type: 'actual',
        metaData: {
          volume: assemblyData['meta_data.volume'] || 0,
          volumeUnit: assemblyData['meta_data.unit'] || '',
        },
      }
    })
  }
  ...
  const inputProject: InputProject = {
    ...
    metaData: {
      projectClassificationSystem: projectData['meta_data.project_classification_system'] || '',
      image: projectData['meta_data.image'] || '',
      climateZone: projectData['meta_data.climate_zone'] || '',
      owner: {
        contact: projectData['meta_data.owner.contact'] || '',
        webDomain: projectData['meta_data.owner.web'] || '',
        location: projectData['meta_data.owner.location'] || '',
        country: projectData['meta_data.owner.country'] || '',
        email: projectData['meta_data.owner.email'] || '',
        phone: projectData['meta_data.owner.phone'] || '',
        type: projectData['meta_data.owner.type'] || '',
        representative: projectData['meta_data.owner.representative'] || '',
      },
      nameOfAssessor: projectData['meta_data.assessment_assessor_name'] || '',
      emailOfAssessor: projectData['meta_data.assessment_assessor_email'] || '',
      assessorOrganization: projectData['meta_data.assessment_assessor_organization'] || '',
      dataReportedYear: projectData['meta_data.assessment_year'] || 0,
      dateOfAssessment: projectData['meta_data.assessment_date'] || '',
      purposeOfAssessment: projectData['meta_data.purpose_of_assessment'] || '',
      isCompliantISO21931: projectData['meta_data.assessment_21931_compliance'] || false,
      isCompliantEN15978: projectData['meta_data.assessment_15978_compliance'] || false,
      isCompliantRICS2017: projectData['meta_data.assessment_rics_2017_compliance'] || false,
      isCompliantRICS2023: projectData['meta_data.assessment_rics_2023_compliance'] || true,
      isCompliantASHRAE240P: projectData['meta_data.assessment_ashrae_240p_compliance'] || true,
      thirdPartyVerified: projectData['meta_data.assessment_verified'] || false,
      verifierInfo: projectData['meta_data.assessment_verified_info'] || '',
      validityPeriodYears: projectData['meta_data.assessment_validity_period'] || 0,
      uncertaintyPercentage: projectData['meta_data.assessment_ec_uncertainty'] || false,
      lcaSoftwareVersion: projectData['meta_data.lca_software_version'] || '',
      newlyBuiltArea: projectData['meta_data.newly_built_area.value'] || 0,
      retrofittedArea: projectData['meta_data.retrofitted_area.value'] || 0,
      demolishedArea: projectData['meta_data.demolished_area.value'] || 0,
      existingArea: projectData['meta_data.existing_area.value'] || 0,
      detailedConstructionType: projectData['meta_data.building_project_construction_type_2'] || '',
      infrastructureConstructionType: projectData['meta_data.infrastructure_project_construction_type'] || '',
      infrastructureSectorType: projectData['meta_data.infrastructure_sector_type'] || '',
      buildingUseType: projectData['meta_data.building_use_type'] || '',
      infrastructureUseType: projectData['meta_data.infrastructure_use_type'] || '',
      projectWorkAreaM2: projectData['meta_data.project_work_area_m2'] || 0,
      projectSiteAreaM2: projectData['meta_data.project_site_area_m2'] || 0,
      conditionedFloorAreaM2: projectData['meta_data.conditioned_floor_area_m2'] || 0,
      unconditionedFloorAreaM2: projectData['meta_data.unconditioned_floor_area_m2'] || 0,
      enclosedParkingAreaM2: projectData['meta_data.enclosed_parking_area_m2'] || 0,
      detachedParkingAreaM2: projectData['meta_data.detached_parking_area_m2'] || 0,
      ibcConstructionType: projectData['meta_data.ibc_construction_type'] || '',
      projectSurroundings: projectData['meta_data.project_surroundings'] || '',
      projectHistoric: projectData['meta_data.project_historic'] || '',
      occupantLoad: projectData['meta_data.occupant_load'] || 0,
      meanRoofHeight: projectData['meta_data.mean_roof_height'] || 0,
      windowWallRatio: projectData['meta_data.window_wall_ratio'] || 0,
      thermalEnvelopeArea: projectData['meta_data.thermal_envelope_area'] || 0,
      residentialUnits: projectData['meta_data.residential_units'] || 0,
      expectedBuildingLifeYears: projectData['meta_data.project_expected_life'] || 0,
      resultsValidatedAsBuilt: projectData['meta_data.results_validated_as_built'] || false,
      resultsValidatedAsBuiltDescription: projectData['meta_data.results_validated_as_built_description'] || '',
      assessmentCutoffMethod: projectData['meta_data.assessment_cutoff_type'] || '',
      materialsPercentageAssessmentMass: projectData['meta_data.assessment_cutoff'] || 0,
      materialsCostAssessment95: projectData['meta_data.assessment_cost_cutoff'] || false,
      heritageStatus: projectData['meta_data.heritage_status'] || '',
      energyModelingTool: projectData['meta_data.project_tool_energy_modeling'] || '',
      energyModelingToolVersion: projectData['meta_data.project_tool_energy_modeling_version'] || '',
      architectOfRecord: projectData['meta_data.architect_of_record'] || '',
      projectUserStudio: projectData['meta_data.project_user_studio'] || '',
      generalContractor: projectData['meta_data.general_contractor'] || '',
      mepEngineer: projectData['meta_data.mep_engineer'] || '',
      sustainabilityConsultant: projectData['meta_data.sustainability_consultant'] || '',
      structuralEngineer: projectData['meta_data.structural_engineer'] || '',
      civilEngineer: projectData['meta_data.civil_engineer'] || '',
      landscapeConsultant: projectData['meta_data.landscape_consultant'] || '',
      interiorDesigner: projectData['meta_data.interior_designer'] || '',
      otherProjectTeamMember: projectData['meta_data.other_project_team'] || '',
      workCompletionYear: projectData['meta_data.work_completion_year'] || '',
      buildingPermitYear: projectData['building_permit_year'] || '',
      constructionStart: projectData['meta_data.construction_start'] || '',
      constructionYearExistingBuilding: projectData['meta_data.construction_year_existing_building'] || '',
      buildingOccupancyStart: projectData['meta_data.building_occupancy_start'] || '',
      designCompletion: projectData['meta_data.design_completion'] || '',
      projectTotalCostCurrency: projectData['meta_data.project_total_cost_currency'] || '',
      projectTotalCost: projectData['meta_data.project_total_cost'] || '',
      projectHardCost: projectData['meta_data.project_hard_cost'] || '',
      projectSoftCost: projectData['meta_data.project_soft_cost'] || '',
      projectSiteworksCost: projectData['meta_data.project_siteworks_cost'] || '',
      projectCostSource: projectData['meta_data.project_cost_source'] || '',
      systemColumnGridLong: projectData['meta_data.system_column_grid_long'] || '',
      systemRiskCategory: projectData['meta_data.system_risk_category'] || '',
      systemLiveLoad: projectData['meta_data.system_live_load'] || '',
      systemSnowLoad: projectData['meta_data.system_snow_load'] || '',
      systemWindSpeed: projectData['meta_data.system_wind_speed'] || '',
      systemSeismicDesignCategory: projectData['meta_data.system_seismic_design_category'] || '',
      systemHorizontalGravitySystem: projectData['meta_data.system_horizontal_gravity_system'] || '',
      systemVerticalGravitySystem: projectData['meta_data.system_vertical_gravity_system'] || '',
      systemLateralSystem: projectData['meta_data.system_lateral_system'] || '',
      systemPodium: projectData['meta_data.system_podium'] || '',
      allowableSoilBearingPressurePSF: projectData['meta_data.system_allowable_soil_bearing_pressure_psf'] || '',
      systemFoundationType: projectData['meta_data.system_foundation_type'] || '',
      secondaryHorizontalGravitySystem: projectData['meta_data.secondary_horizontal_gravity_system'] || '',
      secondaryVerticalGravitySystem: projectData['meta_data.secondary_vertical_gravity_system'] || '',
    },
  }
