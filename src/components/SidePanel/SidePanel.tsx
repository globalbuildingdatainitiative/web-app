...
//       items: [
//         { name: 'Details', Logo: IconListDetails, link: '/details', roles: [] },
//       ]
//     },
//     {
//       name: 'Management',
...
//   const currentPageItem = menuSections
//     .flatMap(section => section.items)
//     .find(item => onCurrentPage(item.link)) || menuSections[0].items[0]
//
//   return (
//     <div style={{
...
//           </Group>
//         ) : (
//           <Button onClick={toggleCollapsed} variant='transparent' color='gray'
...
//             .map(section => ({
//               ...section,
//               items: section.items.filter(({ roles }) =>
//                 roles.length === 0 || roles.some(role => hasRole(user!, role))
//               )
//             }))
