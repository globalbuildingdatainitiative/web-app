...
const alpha3ToLatLon: { [key: string]: { lat: number; lon: number } } = {
  ...
  shn: { lat: -15.9650, lon: -5.7089 },
  kna: { lat: 17.3578, lon: -62.7830 },
